...
Arrhenius (See Fig.~\ref{Arrhenius_interp}).

\begin{figure}
\centering
\framebox{\rule[-2cm]{0pt}{3cm}\rule{3cm}{0pt}TO BE PRODUCED\rule{3cm}{0pt}}
\caption{\label{Arrhenius_interp}}
\end{figure}
...
\multirow{2}{*}{Three-Body falloff}
                  & \multirow{2}{*}{$\chemProc = \frac{\kinModZ\threeBody}{1 + \frac{\kinModZ}{\kinModI}\threeBody}\Falloff$}
                                          & \ref{Falloff:doverdT} with $F = \FTroe\text{ or }\FLind$\\
