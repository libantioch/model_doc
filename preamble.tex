%first thing first
\graphicspath{{./figs/}}
\newcommand{\font@library}[1]{\texttt{#1}}
\newcommand{\font@prog}[1]{\textsf{#1}}
\newcommand{\make@program}[1]{%
\expandafter\gdef\csname#1\endcsname{\font@prog{#1}}%
}
\newcommand{\antioch}{\font@library{Antioch}}
\newcommand{\Antioch}{\font@library{Antioch}}
