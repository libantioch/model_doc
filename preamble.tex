...
%%%% meta-meta-function
\newcommand{\make@}[2]{%
\expandafter\gdef\csname font@#1\endcsname##1{% create font@something macro
{\csname#2\endcsname{##1}}%
}%
\expandafter\gdef\csname make@#1\endcsname##1{% create make@something meta macro
\expandafter\gdef\csname ##1\endcsname{\csname font@#1\endcsname{##1}}%
}
}
%% meta function
\make@{program}{sf}
...
\fancyhead{} %empty
\fancyhead[LO]{\parbox[b]{0.45\textwidth}{\leftmark}}
\fancyhead[RE]{\parbox[b]{0.45\textwidth}{\raggedleft\leftmark}}
\fancyhead[LE]{\parbox[b]{0.45\textwidth}{\rightmark}}
