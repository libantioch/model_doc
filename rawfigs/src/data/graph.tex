...
\geometry{paperwidth=50cm, paperheight=30cm,left=2pt,right=2pt,top=2pt,bottom=2pt}
\makeatletter%
%
...
diffusivitySet/.style={see=1,subpartA},
...
diffusivitySet/.style={see=0.2,subpartA}
}
}
...
\begin{pgfonlayer}{background}
\node[fit = (DiffSet) (BinMolDiff), diffusionSet] (diffusion) {};
\end{pgfonlayer}
...
\begin{pgfonlayer}{background}
\node[diffusivitySet, fit = (LewisDiff), rounded corners] (diffusivity) {};
\end{pgfonlayer}
...
% thermo
\node[thermoPart, fit = (CEAcurve) (CEAthermo)] (thermo) {};
% transport
\node[transportPart,fit = (WilEval) (visco) (thermalCond) (diffusion) (diffusivity), inner sep = 5mm] (transport) {};
% chemistry
