...
[clockwise from=120]
        child[data]{node[ballmeup=\datacolor] {name}}
        child[data]{node[ballmeup=\datacolor] {mass}}
        child[data]{node[ballmeup=\datacolor] {formation enthalpie at $0^\circ$C}}
        child[data]{node[ballmeup=\datacolor] {translational-rotational numbers of degres of freedom}}
        child[data]{node[ballmeup=\datacolor] {charge}}
                }
