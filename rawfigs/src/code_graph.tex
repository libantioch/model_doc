...
partA/.style={draw,dashed,rounded corners=20pt,very thick,fill = white, drop shadow={shadow xshift = 5mm, shadow yshift = -5mm}}
}
...
% thermo
\node[draw, fit = (CEAcurve) (CEAthermo), partA] (thermo) {};
% transport
\node[fit = (WilEval) (visco) (thermalCond) (diffusion) (diffusivity), partA, inner sep = 5mm] (transport) {};
% chemistry
\node[draw, fit = (chem) (kin) (kinEval), partA] (kinetics) {};
\end{pgfonlayer}
%%
%%%%%%%%%%%%%%
%%%%%%%%%%%%%%
