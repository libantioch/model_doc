...
partA/.style={draw,draw opacity=#1,fill opacity=1,dashed,rounded corners=20pt,very thick,fill = white, drop shadow={shadow xshift = 5mm, shadow yshift = -5mm, opacity=#1}},
...
% transport
\node[fit = (WilEval) (visco) (thermalCond) (diffusion) (diffusivity), partA={0.2}, inner sep = 5mm] (transport) {};
% chemistry
